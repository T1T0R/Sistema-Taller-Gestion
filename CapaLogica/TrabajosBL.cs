...
public class TrabajosBL
{
    ...
    public bool ActualizarValor(string columnaSeleccionada, object nuevoValor, int id)
    {
        ...
        if (new List<string> { "DNI", "ApellidoNombre", "Telefono", "Domicilio" }.Contains(columnaSeleccionada))
        {
            tabla = "Clientes";
            idColumna = "IdCliente";
        }
        else if (new List<string> { "FechaIngreso", "Estado", "Presupuesto", "PrecioArreglo" }.Contains(columnaSeleccionada))
        {
            tabla = "Trabajos";
            idColumna = "IdTrabajo";
        }
        else if (new List<string> { "Equipo", "FallaDeclarada", "Modelo", "NumeroSerie", "Detalles", "Control", "Cable", "Base", "Categoria" }.Contains(columnaSeleccionada))
        {
            tabla = "Equipos";
            idColumna = "IdEquipo";
        }
